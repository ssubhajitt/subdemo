...
def webhook():
    url = \
        'https://nwave-ideabot-flask-webhook-p.herokuapp.com/storedata'
    global output
    output = {}
    try:
...
def intRegression(req):
    ...
    dataset = \
        pd.read_excel('https://github.com/s-gunalan/nWave-Flask-Demo/blob/master/dataset_integration_v2.xlsx?raw=true'
                      , skip_header=1)
